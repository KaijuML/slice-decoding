...
class HierarchicalTransformerEncoder(torch.nn.Module):
    ...
    def forward(self, src, lengths, n_primaries):
        ...
        # Note that this includes a "fake" game_repr entity at position 0
        # We will have to remember with this in the attention module
        ...
        memory_bank = {
            ...
            'primary_mask': high_level_mask[:, 0, :].unsqueeze(0).eq(float('-inf')),
