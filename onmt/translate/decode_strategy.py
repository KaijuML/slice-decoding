...
class DecodeStrategy(object):
    ...
    def __init__(self, vocab, batch_size, parallel_paths, min_length, max_length,
        ...
        # Tracking results for all batch example
        ...
        self.states = [list() for _ in range(batch_size)]
        ...
        # Tracking all attention layers and decoder states
        self.alive_attn = None
        self.alive_states = None
